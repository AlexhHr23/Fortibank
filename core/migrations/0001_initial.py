    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('failed', 'Transferir'), ('complete', 'Transferir'), ('pending', 'Transferir'), ('processing', 'Transferir')], default='pending', max_length=100)),
                ('transaction_type', models.CharField(choices=[('failed', 'Transferir'), ('complete', 'Transferir'), ('pending', 'Transferir'), ('processing', 'Transferir')], default='none', max_length=100)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(blank=True, null=True)),
                ('reciever', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='receiver', to=settings.AUTH_USER_MODEL)),
